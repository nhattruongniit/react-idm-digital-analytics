...
const StyledRight = styled.div`
  width: 45%;
  .bx--select, #convert-project-modal, .bx--select-input__wrapper {
    width: 100%;
  }
`
...
const ConvertProjectModal = ({ isShowing, simulationId, simulationName, cancelFn, convertFn, sizeModal }) => {
