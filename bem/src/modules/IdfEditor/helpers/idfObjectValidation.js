...
export function validateObjectValue(fieldDefinition, value) {
  ...
  let inputType = '';
  if (!fieldDefinition.options.type || fieldDefinition.options.choices === null && fieldDefinition.options.type === 'alpha') {
    inputType = 'text'
  } else if (!fieldDefinition.options.type || fieldDefinition.options.choices === null && fieldDefinition.options.type === 'node') {
    inputType = 'node'
  } else {
    inputType = 'number'
  }
