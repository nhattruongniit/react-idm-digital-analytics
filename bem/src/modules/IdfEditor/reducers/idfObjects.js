...
export const selectPage = (pageNumber, isAddNew) => async (
  ...
  const count = response.found_rows;
...
export const saveIdfObjectFieldChange = (objectId, fieldName, value, extensibleName, extensibleIndex) => async (
  ...
  if (!extensibleName) {
    ...
    if(!object.extensions[extensibleName]) object.extensions[extensibleName] = [];
    if(!object.extensions[extensibleName][extensibleIndex]) object.extensions[extensibleName][extensibleIndex] = {};
