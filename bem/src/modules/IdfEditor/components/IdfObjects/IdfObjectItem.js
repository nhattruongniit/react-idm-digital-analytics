...
const IdfObjectItem = ({
  ...
  function addNewExtensibleObject(){
    console.log("debug: ", extensibleFieldGroups, extensibleFields);
    extensibleFields.forEach( extField => {
      onChange(extField.idd_name, "", extField.options.extensible, extensibleFieldGroups.length);
    })
  }
  ...
  return (
    <Container>
      ...
      {extensibleFields.length > 0 && <Row
        onClick={ () => addNewExtensibleObject() }
      >Add Extensible</Row>}
