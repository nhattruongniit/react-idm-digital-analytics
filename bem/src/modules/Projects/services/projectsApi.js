...
export const fetchDocuments = (projectId, current_page, per_page, sortDirection, keyword) => {
  let options = {
  ...
  return collaborationApi.getProjectDocuments(projectId, options);
...
export const updateCollaboratorPermission = (projectId, email, permission) => request.post(
  `/projects/${projectId}/change-collaborator-permission`, {
...
export const makePublic = (projectId, params) => {
  return request.post(
    `/projects/${projectId}/publish`, params, { showSpinner: true }
  )
} 

export const makePrivate = projectId => request.post(
  `/projects/${projectId}/makeprivate`, null, { showSpinner: true }
)


// console.log(
//   "debug: updateCollaboratorPermission", [projectId, email, permission]
// )
