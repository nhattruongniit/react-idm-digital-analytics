...
import { Modal, Dropdown, InlineLoading, RadioButton, TextInput } from 'carbon-components-react';
    ...
    >
      { isSelectingOptions &&
        <>
          ...
          <Label className="bx-text-default">Select an option for the upgraded IDF Documents</Label>
          <Row>
            <Col md={6}>
              <StyledRadioButton
          ...
          <Row>
            <Col md={6}>
              <Label  className="bx-text-default">Select IDF Version</Label>
              <Dropdown
